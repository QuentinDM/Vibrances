    ...
    <section className="cards-section">
      <div className="cards-grid">
        ...
        <div className="service-card">
          ...
          <p className="card-desc">Une offre pensée pour les <b>pompes funèbres, wedding planners, officiants, chef(fe) d'entreprise, CSE et EHPAD</b> et structures d'accueil qui veulent enrichir leur catalogue avec des <b>textes et chansons personnalisés</b>, sans exposer leur sous-traitance.</p>
          <Link to="/contact" className="card-link">
            En savoir plus
            <i className="fa-solid fa-arrow-right" aria-hidden="true"></i>
          </Link>
